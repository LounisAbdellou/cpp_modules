...
static void floatConvert(std::string param) {
  ...
  std::cout << "float: " << std::fixed << std::setprecision(2) << n << "f"
            << std::endl;
...
static void doubleConvert(std::string param) {
  ...
  std::cout << "float: " << std::fixed << std::setprecision(2)
            << static_cast<float>(n) << "f" << std::endl;
  std::cout << "float: " << std::fixed << std::setprecision(2) << n
            << std::endl;
}
...
void ScalarConverter::convert(const std::string &param) { checkInput(param); }
